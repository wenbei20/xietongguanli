<template>
  <div class="XQ_and_QX gray">
    <div class="editcontainer">
            ...
            <div class="xuqiuform">
              ...
              <div class="item">
                ...
                <div>
                  ...
                  <el-dropdown trigger="click" placement="bottom-start" class="Common_select">
                      <span class="el-dropdown-link bgf">
                        {{ CSelectedJoinGroup }}<i class="el-icon-arrow-down el-icon--right" />
                      </span>
              ...
              <div class="item">
                <span>预估工时</span>
                <div>
                  <!-- <el-select v-model="fuzeren" filterable placeholder="请选择" size="mini">
                    <el-option label="--空--" :value="1" />
                  </el-select> -->
                  <el-input v-model="fuzeren" size="mini" />
                </div>
              </div>
              <div class="item">
                <span>预计开始</span>
      ...
      <div class="editbtns">
        <el-button type="primary" @click="$router.push({name:'mission'})">提交</el-button>
        <el-button  >连续添加</el-button>
        <el-button @click="$router.push({name:'mission'})">取消</el-button>
      </div>

    </div>
    <xuqiuDialog :dialogVisible.sync="showSelectDialog"></xuqiuDialog>
  </div>
</template>
<script>
