<template>
  ...
  >
    ...
    <div class="cardouter">
      <div v-for="(ele , i ) in mobanList" :key="i" class="item" :class="{'select':i === selectedPro}" @click="selectedPro = i">
        <div>
    ...
    <div class="inputarea">
      <el-input v-model="name" size="mini" style="margin-bottom:12px;" placeholder="项目名称" />
      <el-input v-model="descirbe" size="mini" type="textarea" placeholder="项目描述（可选）" />
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      name: '',
      descirbe: '',
      mobanList: [{ name: '敏捷开发模板' }, { name: '专项测试模板' }]
