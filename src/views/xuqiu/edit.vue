...
客户要求达到：当该点距离上一个巡检点不足三分钟，终端无法进入下一个巡检点内容，无法打点。</p>
              ...
              <el-tab-pane name="five">
                ...
                <div class="sonheader">
                  <div style="overflow:hidden;margin-bottom:10px;max-height:18px">
                    ...
                    <span class="add" @click="showXuqiuDialog = true" style="margin-left:8px;color:#3582fb;">
            ...
            <div class="next">
              ...
              <div class="next_cnt">
                ...
                <div class="outer">
                  <div>
                    <span>处理人</span>
                    <el-dropdown trigger="click" placement="bottom-start" class="Common_select" style="width:300px;">
            ...
            <div class="liuzhuanbtn">
              <el-button type="primary" @click="$router.push({name:'Needs'})">流转</el-button>
            </div>
