<template>
  <div class="xuqiu_container XQ_and_QX">
    <div class="list-head">
      <div class="btns">
        <el-button type="primary" size="medium" @click="toaddpage"> <i class="el-icon-plus" /> 创建需求</el-button>
        <el-select v-model="caozuo" placeholder="更多操作">
          <el-option label="需求分布统计" value="1" />
          <el-option label="导出需求" value="2" />
          <el-option label="导入需求" value="3" />
          <el-option label="打印需求卡" value="4" />
        </el-select>
      </div>
      <div class="options">
        <div class="shitu">
