<template>
  ...
  >
   ...
   <div class="inputarea">
        <el-input size="mini" style="margin-bottom:12px;" v-model="name" placeholder="项目名称"></el-input>
        <el-input size="mini" type="textarea" v-model="descirbe" placeholder="项目描述（可选）"></el-input>
   </div>
