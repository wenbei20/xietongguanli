        ...
        <el-card class="box-card" :body-style="{ padding: '0', height: '448px' }">
          <div slot="header" class="clearfix">
            ...
            <span style="float: right;">
              <el-button class="Link_disabled_click" type="text" size="small" style="padding: 5px 0; font-size: 14px;"><i class="el-icon-refresh-left" /></el-button>
              <el-button class="Link_disabled_click" type="text" size="small" style="padding: 5px 0; font-size: 14px;"><i class="el-icon-more-outline" /></el-button>
            </span>
          </div>
          <el-table
            :data="tableData"
            ...
            <el-table-column prop="title" label="标题" min-width="280" >
              <template slot-scope="scope">
                <div class="onelineCol" @click="topage(scope.row.route)">
                  ...
                  <span  :class="['sprite',scope.row.category]"></span>
                  {{ scope.row.title }}
                </div>
              </template>
            </el-table-column>
        ...
        <el-card class="box-card" :body-style="{ padding: '0', height: '448px' }">
          <div slot="header" class="clearfix">
            ...
            <span style="float: right;">
              ...
              <el-button  class="Link_disabled_click" type="text" size="small" style="padding: 5px 0; font-size: 14px; margin-left:20px;"><i class="el-icon-refresh-left" /></el-button>
              <el-button  class="Link_disabled_click" type="text" size="small" style="padding: 5px 0; font-size: 14px;"><i class="el-icon-more-outline" /></el-button>
            </span>
          </div>
          <el-table
...
export default {
  ...
  data() {
    return {
      tableData: [
        { category: 'STORY', title: '巡检地图对瓦片格式多层级支持', status: '2', priority: 'Middle', belong: '巡检管理软件V3.0_P19010' ,route:'Needs'},
        { category: 'BUG', title: '蓝星星火-巡检app-终端已提交数据，在任务一览界面显示未提交', status: '2', priority: 'Middle', belong: '产品需求池' ,route:'Defect'},
        { category: 'BUG', title: '【蓝星星火巡检后台】基础信息的巡检终端设置选择车间级删除终端编码成功后仍然保留', status: '2', priority: null, belong: '产品需求池' ,route:'Defect'},
        { category: 'STORY', title: '九江石化服务器漏洞扫描以及漏洞修复', status: '1', priority: 'High', belong: '产品需求池' ,route:'Needs'},
        { category: 'STORY', title: '零一众方案集成', status: '1', priority: '', belong: '产品需求池' ,route:'Needs'},
        { category: 'TASK', title: '配置库备份恢复机制制定', status: '3', priority: '', belong: '测试部日常管理_TD19001' ,route:'mission'}
