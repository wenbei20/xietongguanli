          ...
          <el-col :span="6" class="right">
            <div class="xuqiuform">
              ...
              <div class="item">
                <span>系统模板</span>
                <div>
                  <el-select v-model="diedai" filterable placeholder="选择模板" size="mini">
                    <el-option label="--空--" :value="1" />
                    <el-option label="模板1" :value="2" />
                  </el-select>
                </div>
              </div>
              <div class="item">
                <span>所属团队</span>
                <div>
                  <el-select v-model="youxian" filterable placeholder="选择团队" size="mini">
                    <el-option label="团队1" :value="1" />
                    <el-option label="团队2" :value="2" />
                    <el-option label="团队3" :value="3" />
                    <el-option label="团队4" :value="4" />
                  </el-select>
                </div>
              </div>
              ...
              <div  class="item">
                <span>所属部门</span>
                <div>
                  <el-select v-model="bumen" filterable placeholder="选择部门" size="mini">
              ...
              <div class="item">
                <span>所属批次</span>
                <div>
                  <el-select v-model="degree" filterable placeholder="选择批次" size="mini">
              ...
              <div class="item">
                <span>来源任务</span>
                <div>
                  <el-select v-model="laiyuan" filterable placeholder="选择任务" size="mini">
                    <el-option label="任务1" :value="1" />
                    <el-option label="任务2" :value="2" />
                    <el-option label="任务3" :value="3" />
                  </el-select>
                </div>
              </div>
              <!-- <div class="item">
...
export default {
  ...
  created() {
    ...
    //   this.isQueXian = true
    // }
    if (this.$route.query && this.$route.query.from === 'mission'){
      this.TitleName = '创建任务'
    }

    if (this.$route.query && this.$route.query.from === 'product'){
      this.TitleName = '创建产品'
    }
