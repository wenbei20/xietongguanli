<template>
  <div class="xuqiu_container XQ_and_QX">
    <div class="list-head">
      <div class="btns">
        <el-button type="primary" size="medium" @click="toaddpage"> <i class="el-icon-plus" /> 创建项目</el-button>
    ...
    <div class="table">
      ...
      >
        ...
        <vxe-table-column field="eventID" title="项目编号" width="100"/>
        <vxe-table-column field="title" title="项目名称" tree-node width="400">
        ...
        <!-- <vxe-table-column  title="批次年度" tree-node width="100">
        ...
        <vxe-table-column  title="批次描述" tree-node width="200">
...
export default {
  ...
  methods: {
    ...
    toaddpage() {
      this.$router.push({ name: 'batchProjectAdd'})
    },
    toEditPage() {
    ...
    topageManage(){
      this.$router.push({ name: 'batchProjectSettting' })
    }
  }
}
</script>
