<template>
  ...
  <div slot="title" style="font-size:14px;">
   ...
   <div class="cardouter">
      ...
      <el-select v-model="degree" filterable placeholder="批次年度" size="mini" >
        <el-input v-model="testcoltext" prefix-icon="el-icon-search" size="mini" class="select_innerIpt" />
        <el-option label="2020年度" :value="1" />
        <el-option label="2019年度" :value="2" />
        <el-option label="2018年度" :value="3" />
        <el-option label="2017年度" :value="4" />
      </el-select>
   </div>
   ...
   <div class="inputarea" style="margin:20px 0 8px 0;">
        <el-input size="mini" style="margin-bottom:12px;" v-model="name" :placeholder="titleName +'名称'"></el-input>
    ...
    <div class="inputarea">
        ...
        <el-input size="mini" type="textarea" v-model="descirbe" :placeholder="titleName + '描述（可选）'"></el-input>
   </div>
