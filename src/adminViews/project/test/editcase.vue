    ...
    <div class="editcontainer">
      ...
      <div class="header">
        ...
        <div class="select">
          ...
          <!-- <el-button size="mini" @click="$router.push({name:'createCase'})">编辑</el-button> -->
        ...
        <el-row>
          <el-col :span="18" class="left" style="padding-bottom:20px;">
            <el-tabs v-model="activeName" @tab-click="tabClick">
              <el-tab-pane label="前置条件" name="first">
输入正确的账号和密码，点击提交按钮
                <div class="maininfo" />
              </el-tab-pane>
...
登录成功
            ...
            <div class="liuzhuanbtn">
              <el-button type="primary" @click="$router.push({name:'AdminTestcase'})">保存</el-button>
              <el-button @click="$router.push({name:'AdminTestcase'})">取消</el-button>
            </div>
