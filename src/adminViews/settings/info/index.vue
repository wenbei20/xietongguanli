    ...
    <div class="topinfo" :class="{'hideMore':maininfoState.hideMore}">
      ...
      <div class="info">
        ...
        <div class="otherInfo">
          ...
          <div>
            <span class="tit">{{maintitle}}成员</span>
          ...
          <div>
            <span class="tit">{{maintitle}}状态</span>
            <span>{{ maininfo.status }}</span>
            <el-button type="primary"    class="endObj" @click="dialogVisible = true">结束{{maintitle}}</el-button>
          </div>
        </div>
...
export default {
  ...
  created() {
    this.maininfo.name = 'text' + this.maintitle
  },
  methods: {
    showInput(e) {
